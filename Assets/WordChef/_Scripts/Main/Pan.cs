...
public class Pan : MonoBehaviour {
    ...
    private Color blue = new Color (161f / 255f, 216f / 255f, 255f / 255f, 1f);
    ...
    public void Load(string gameWord) {
        this.gameWord = gameWord;
        numLetters = gameWord.Trim ().Length;
        ...
        for (int i = 0; i < numLetters; i++) {
            ...
            letter.text = gameWord[i].ToString ().ToUpper ();
            letter.color = blue;
