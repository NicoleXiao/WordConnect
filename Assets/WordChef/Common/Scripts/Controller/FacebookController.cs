...
public class FacebookController : MonoBehaviour
{
    ...
    {
        Debug.Log ("FaceBook is Initialized : "+FB.IsInitialized);
        if (!FB.IsInitialized) return;
        CallFBLoginForRead();
    }
    ...
    public void ShareLink()
    {
        ...
        FB.ShareLink(new Uri(linkToShare),"Share Game Link", "I'm sharing a  funning game ",callback: HandleResultShareLink);
    }
    ...
    public static void GetMyInfo() {
        if (FB.IsLoggedIn == false) {
            Toast.instance.ShowMessage ("Not login in");
